...
---@alias agent_workbench.DraftPathOverride string|fun(cwd: string, pid: integer): string
---@type agent_workbench.DraftPathOverride?
local path_override = nil

---@param p? agent_workbench.DraftPathOverride
