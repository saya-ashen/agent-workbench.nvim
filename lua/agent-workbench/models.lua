...
---@param entries agent_workbench.ModelEntry[]
...
--- `:AgentWorkbenchNewSession` in this tab keep this model.
        ...
        session.rpc:send({ type = "cycle_model" }, function(res)
            vim.schedule(function()
                if res.success and res.data then
                    ...
                    require("agent-workbench.sessions.manager").refresh_state(session)
