...
---@alias agent_workbench.RpcEventType
---| "agent_start"
---| "agent_end"
---| "message_start"
---| "message_update"
...
---@alias agent_workbench.AssistantMessageEventType
---| "start"
---| "text_start"
---| "text_delta"
---| "text_end"
...
--- https://github.com/earendil-works/pi/blob/main/packages/coding-agent/src/modes/rpc/rpc-types.ts
---@alias agent_workbench.RpcCommandType
---| "prompt"
---| "steer"
---| "follow_up"
---| "abort"
...
---@class agent_workbench.RpcImageContent
---@field type "image"
---@field data string base64-encoded
---@field mimeType string

---@class agent_workbench.RpcCommand
---@field type agent_workbench.RpcCommandType
---@field id? string
---@field message? string
---@field images? agent_workbench.RpcImageContent[]
...
---@field assistantMessageEvent? { type: agent_workbench.AssistantMessageEventType, delta?: string, toolCall?: agent_workbench.ToolCall }
...
---@class agent_workbench.ToolCall
---@field id string
---@field name string
---@field arguments string|table

---@class agent_workbench.Rpc
---@field _job_id integer?
---@field _handler fun(msg: agent_workbench.RpcEvent)?
---@field _pending table<string, fun(msg: agent_workbench.RpcEvent)>
...
local Cli = require("agent-workbench.cli")
...
---@return agent_workbench.RpcAdapterContext
...
function Rpc:_dispatch(msg)
    ...
    if type(event_mapper) == "function" then
        msg = map_event(event_mapper, msg) --[[@as agent_workbench.RpcEvent]]
    end
...
---@param callback? fun(msg: agent_workbench.RpcEvent)
---@return boolean
function Rpc:send(cmd, callback)
    ...
    if type(command_mapper) == "function" then
        cmd = map_command(command_mapper, cmd) --[[@as agent_workbench.RpcCommand]]
    end
    if not cmd then
        return false
    end
...
---@param fn fun(msg: agent_workbench.RpcEvent)
