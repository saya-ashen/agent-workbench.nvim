--- Session statistics: pure formatting and aggregation for :AgentWorkbenchSessionStats.
---
...
---@class agent_workbench.StatsCostEntry
---@field key string
---@field cost number
---@field tokens integer

---@class agent_workbench.StatsTotals
---@field input number
---@field output number
...
---@param totals agent_workbench.StatsTotals
...
---@return agent_workbench.StatsCostEntry[]
...
---@class agent_workbench.StatsCacheWaste
...
---@param entries table[] SessionEntry list from the RPC get_entries response
---@return agent_workbench.StatsCacheWaste
function M.compute_cache_waste(entries)
    ---@type agent_workbench.StatsCacheWaste
...
---@class agent_workbench.StatsRender
---@field lines string[]
...
--- Build the :AgentWorkbenchSessionStats dashboard: lines plus per-line highlight ranges
...
---@param breakdown agent_workbench.StatsCostEntry[] cost breakdown (empty when unavailable)
---@param cache_waste agent_workbench.StatsCacheWaste cache waste totals (all zeros when unavailable)
---@return agent_workbench.StatsRender
