...
---@class agent_workbench.SourceInfo
...
---@class agent_workbench.SlashCommand
---@field name string command name (invoke with /name)
---@field description? string human-readable description
---@field source "builtin"|"extension"|"prompt"|"skill"
---@field sourceInfo? agent_workbench.SourceInfo structured source metadata from pi RPC
...
---@param callback? fun(commands: agent_workbench.SlashCommand[])
