...
---@alias agent_workbench.ImageCompressTool "sips"|"magick"|"ffmpeg"
...
---@param configured string "auto" or a agent_workbench.ImageCompressTool
---@return agent_workbench.ImageCompressTool?
...
---@param cfg agent_workbench.ImageCompressConfig
---@param tool agent_workbench.ImageCompressTool
...
---@param input_mime string
---@param cfg agent_workbench.ImageCompressConfig resolved config
