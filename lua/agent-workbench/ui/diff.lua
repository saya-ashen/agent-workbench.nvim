...
---@class agent_workbench.DiffReviewNote
---@field buf integer
...
---@param width integer
---@return agent_workbench.CustomBlockLine
...
---@param buf integer
---@param row integer
---@param virt_lines agent_workbench.CustomBlockLine[]
...
function M.open(payload, callback, opts)
    ...
    local notes = {} ---@type agent_workbench.DiffReviewNote[]
    ...
    ---@param entry agent_workbench.DiffReviewNote
    ---@return integer
    ...
    ---@param buf integer
    ---@param row integer
    ---@return agent_workbench.DiffReviewNote[]
    ...
    ---@param entries agent_workbench.DiffReviewNote[]
    ---@param title string
    ---@param callback fun(entry: agent_workbench.DiffReviewNote?)
    ...
    ---@param entries agent_workbench.DiffReviewNote[]
    ---@param row integer
    ---@param callback fun(entry: agent_workbench.DiffReviewNote|false?) false means create new; nil means cancelled
    ...
    ---@param existing agent_workbench.DiffReviewNote?
    ---@param buf integer
    ...
    local function accept()
        ...
        responded = true
        require("agent-workbench.cache.files").invalidate()
