...
---@class agent_workbench.ChatPrompt
---@field _buf integer
---@field _win integer?
---@field _layout agent_workbench.LayoutMode
---@field _statusline agent_workbench.StatusLine
...
---@field _on_command_mode_change fun(mode: agent_workbench.PromptCommandMode)?
---@field _on_mode_change fun(mode: agent_workbench.PromptMode, kind?: agent_workbench.PromptRequestKind)?
---@field _on_terminal_resize fun(win: integer, buf: integer)?
---@field _mode agent_workbench.PromptMode
---@field _display_mode agent_workbench.PromptDisplayMode
---@field _request_return_mode agent_workbench.PromptDisplayMode
---@field _request agent_workbench.PromptRequest?
...
---@alias agent_workbench.PromptMode "compose"|"request"
---@alias agent_workbench.PromptDisplayMode "compose"|"terminal"|"request"
...
local Decorators = require("agent-workbench.ui.chat.decorators")
...
---@param cwd? string
---@return agent_workbench.ChatPrompt
function Prompt.new(key, attachments, cwd)
    ...
    vim.bo[self._buf].completefunc = "v:lua.require'agent-workbench.completion.omnifunc'.completefunc"
    vim.bo[self._buf].omnifunc = "v:lua.require'agent-workbench.completion.omnifunc'.completefunc"
...
---@return agent_workbench.StatusLine
function Prompt:statusline()
    return self._statusline
end

---@param cb fun(state: agent_workbench.StatusLineState)?
function Prompt:set_on_status_change(cb)
    self._statusline:set_on_change(cb)
end

---@param cb fun(mode: agent_workbench.PromptCommandMode)
...
---@param cb fun(mode: agent_workbench.PromptMode, kind?: agent_workbench.PromptRequestKind)
...
---@return agent_workbench.PromptMode
function Prompt:mode()
    return self._mode
end

---@return agent_workbench.PromptDisplayMode
...
---@alias agent_workbench.PromptFocusMode "normal"|"insert"

---@param cb? fun()
---@param mode? agent_workbench.PromptFocusMode
