...
function M.get_tool_icon(tool_name)
    return TOOL_ICONS[tool_name] or require("agent-workbench.config").options.labels.tool
end
...
---@class agent_workbench.ToolRenderer
---@field on_start? fun(history: agent_workbench.ChatHistory, args: table?)
---@field on_end? fun(history: agent_workbench.ChatHistory, args: table?, result: table?, is_error: boolean?, insert_at: integer?): integer?
...
---@type table<string, agent_workbench.ToolRenderer>
local renderers = {
    bash = {
        input_visible = 1,
        output_visible = 0,
...
---@type agent_workbench.ToolRenderer
...
---@param tool_name string
---@return agent_workbench.ToolRenderer
