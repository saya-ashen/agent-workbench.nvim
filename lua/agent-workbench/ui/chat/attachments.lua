---@class agent_workbench.Attachment
---@field name string
---@field data string base64-encoded
---@field mime string
---@field size integer byte size of the decoded image (what will be sent)

---@class agent_workbench.ChatAttachments
---@field _items agent_workbench.Attachment[]
---@field _buf integer
...
---@return agent_workbench.ChatAttachments
...
---@return agent_workbench.RpcImageContent[]
function Attachments:get()
    ---@type agent_workbench.RpcImageContent[]
    local result = {}
    for _, item in ipairs(self._items) do
