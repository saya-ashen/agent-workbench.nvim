...
---@alias agent_workbench.StatusLineComponentFn fun(state: agent_workbench.StatusLineState): string|string[][]|nil, string|nil

--- Display model for the busy (spinner) component, pushed by ChatHistory.
---@class agent_workbench.StatusLineBusy
...
---@class agent_workbench.StatusLineState
...
---@field busy agent_workbench.StatusLineBusy? Busy/spinner display model (nil = idle)
...
---@class agent_workbench.StatusLine
---@field _buf integer
---@field _tab agent_workbench.TabId
---@field _win_fn fun(): integer?
---@field _extmark_id integer?
---@field _virt_line_count integer
---@field _on_change fun(state: agent_workbench.StatusLineState)?
---@field _state agent_workbench.StatusLineState
...
--- Shared with the :AgentWorkbenchSessionStats dashboard.
local format_tokens = require("agent-workbench.stats").format_tokens
...
---@param name agent_workbench.StatusLineBuiltinName
---@return table
...
---@type table<string, agent_workbench.StatusLineComponentFn>
local builtin = {}
...
---@return agent_workbench.StatusLineComponentFn
...
---@return agent_workbench.StatusLineState
...
---@param callback fun(state: agent_workbench.StatusLineState)?
...
---@param busy agent_workbench.StatusLineBusy?
...
---@param item any
---@param tab agent_workbench.TabId
---@return agent_workbench.StatusLineComponentFn?, agent_workbench.StatusLineBuiltinName?
