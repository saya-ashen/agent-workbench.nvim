...
local Session = require("pi.ui.chat.terminal.shell.session")
...
---@field decorations? pi.ShellOutputDecorations
...
---@class pi.ShellResult
---@field block pi.ShellBlock
---@field output string[]
---@field status integer
---@field duration_ms integer
---@field cwd_after? string
...
---@field _active pi.ShellBlock?
---@field _blocks pi.ShellBlock[]
---@field _pending_results pi.ShellResult[]
---@field _user_folds pi.ShellFold[]
...
---@field _session pi.ShellSession
---@field completion_context fun(self: pi.ShellWorksheet, cursor: integer[]): pi.ShellCompletionContext?
---@field request_completion fun(self: pi.ShellWorksheet, commandline: string, callback: fun(output: string)): boolean, string?
local Worksheet = {}
...
function Worksheet:_apply_folds(rebuild)
    ...
    vim.api.nvim_win_call(win, function()
        ...
        vim.wo[win].foldtext = "v:lua.require'pi.ui.chat.terminal.worksheet'.foldtext()"
        if rebuild then
