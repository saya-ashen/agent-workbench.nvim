...
---@field style? pi.ShellAnsiStyle
---@field priority integer
---@field hl_eol? boolean

---@class pi.ShellOutputIcon
---@field row integer 0-based within command output
---@field col integer 0-based byte column
---@field text string
---@field hl_group string

---@class pi.ShellOutputDecorations
---@field kind "text"|"json"|"diff"
---@field spans pi.ShellOutputSpan[]
---@field icons pi.ShellOutputIcon[]
...
---@param decorations pi.ShellOutputDecorations
---@param span pi.ShellOutputSpan
...
---@param cwd string|string[]
---@return pi.ShellOutputDecorations
